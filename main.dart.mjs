...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      CK: (x0,x1) => x0.transferFromImageBitmap(x1),
      CL: (x0,x1) => { x0.draggable = x1 },
      ...
      IJ: x0 => new Blob(x0),
      IK: x0 => x0.rasterEndMilliseconds,
      IL: x0 => x0.value,
      ...
      JK: x0 => x0.rasterStartMilliseconds,
      JL: x0 => x0.done,
      K: (exn) => {
      ...
      LJ: x0 => x0.name,
      LK: x0 => x0.canvasKitMaximumSurfaces,
      LL: x0 => x0.body,
      M: o => String(o),
      MB: (o, p) => o[p],
      ...
      QI: x0 => x0.deref(),
      QJ: x0 => x0.ready,
      QK: (x0,x1) => x0.getModifierState(x1),
      ...
      aI: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      aJ: (x0,x1) => x0.getRandomValues(x1),
      aK: () => globalThis.window,
      b: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      bJ: () => globalThis.crypto,
      bK: (x0,x1) => x0.getItem(x1),
      c: o => o,
      cB: o => {
        if (o === null || o === undefined) return 0;
      ...
      cJ: l => new DataView(new ArrayBuffer(l)),
      cK: (x0,x1) => x0.key(x1),
      d: (o, p) => o[p],
      ...
      gH: x0 => x0.iterator,
      gI: x0 => x0.getAllResponseHeaders(),
      ...
      kJ: x0 => x0.response,
      kK: (x0,x1,x2) => x0.addEventListener(x1,x2),
      l: o => {
        if (o === undefined || o === null) return 0;
      ...
      qJ: x0 => globalThis.URL.createObjectURL(x0),
      ...
      vH: x0 => x0.id,
      vI: (x0,x1) => { x0.src = x1 },
      vJ: x0 => globalThis.URL.revokeObjectURL(x0),
      vK: x0 => x0.name,
